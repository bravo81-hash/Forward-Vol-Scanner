...
class Zebra(Strategy):
    ...
    def propose(self, ctx: Context) -> list[Suggestion]:
        ...
        # Breakeven comes from struct_metrics (s.breakevens), which walks the
        # actual payoff. The closed form 2K_long - K_short + debit is only valid
        # ABOVE the short strike, and silently returns a wrong number when the
        # true breakeven falls between the strikes.
        ...
        s.manage = {
            "roll": "Roll out before the position drops under 90 days to expiry.",
